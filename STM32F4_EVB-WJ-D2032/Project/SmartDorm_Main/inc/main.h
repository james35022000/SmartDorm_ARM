...
bool runCommand(int);
bool isCommand(char[]);
void USART2_SendData(char*);
void printUartData(void);
void getUartData(void);
void USART2_IRQHandler(void);
void WCS_Update_func(void);
void WCS_Lineup_func(void);
void WCS_auth(void);
struct WashingClothesServer* WCS_Exist(char[]);
void WCS_Finished(void);
bool if_time_more_than(const char[], const char[]);
void time_add(char[], const int);
int monthGetDate(int);
/* Global variables */
extern bool welFlag;
